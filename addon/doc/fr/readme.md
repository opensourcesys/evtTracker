...
* NVDA 2024.1 ou version ultérieure est requis en raison de la mise à niveau de Python 3.11.
...
* NVDA enregistrera le nom du rôle de contrôle réel au lieu des entiers lors du signalement des événements.

## Version 24.1.0

* Compatibilité NVDA 2024.1.
* opensourcesys/evtTracker #4: La description du premier événement ne manque plus lors de l'ouverture de la visionneuse de l'événement. Contribué par: WangFeng Huang (hwf1324)
