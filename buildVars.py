...
addon_info = {
	...
	"addon_url": "https://github.com/opensourcesys/evtTracker#readme",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/opensourcesys/evtTracker",
